...
if(isset($_POST['registerBtn']))
{
    ...
    $query = "INSERT INTO users (role,name,phone,email,password,department,semester) VALUES ('User','$name','$phone','$email','$password','$department','$semester')"; // Updated query to include department and semester
